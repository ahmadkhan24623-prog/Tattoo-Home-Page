...
const HeroSection: React.FC = () => {
  ...
  useEffect(() => {
    // Smooth responsive entrance sequence animations
  ...
  return (
    ...
    >
      ...
      {/* RIGHT COLUMN: Artwork Frame Component */}
      <div 
        ref={rightSideRef} 
      ...
      >
        ...
        {/* Rounded mask container for Hero Artwork Asset */}
